package org.ihtsdo.reconciliation.test;
...
import org.ihtsdo.reconciliation.RelationshipReconciliation;
...
public class GroupNumberReconciliationTest extends TestCase {
	...
	public void testGroupMumberReconciliation() throws Exception{
		File TestGroupMumberReconciliationFile=new File("src/test/resources/org/ihtsdo/reconciliation/test/GroupNumberReconciliationConfig.xml");
		...
		for(Relationship prevRelationship:previousRelationships){
			Relationship outputRelationship=getSameReconciliatedRel(prevRelationship, outputRelationships);
			if (outputRelationship!=null){
				assertTrue(outputRelationship.group==prevRelationship.group);
			}
		}

	}
	private Relationship getSameReconciliatedRel(Relationship relationship,
